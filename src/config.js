...
export const RUN = Object.freeze({ maxTime: 180, stuckSeconds: 12, transitionSeconds: 0.35, crashSeconds: 2.2, crashMaxSeconds: 6 });
export const TEMPORAL = Object.freeze({ activationDistance: 60 });
